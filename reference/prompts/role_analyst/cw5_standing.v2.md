...
5. Write `reach`: one sentence about the level they are targeting, and it must contain the reach label exactly as you were given it. When you were given no target, leave it empty.
...
- You are shown only the largest few gaps, not all of them. Name the ones you were given. Do not say how many there are in total, and do not imply the list is complete.
